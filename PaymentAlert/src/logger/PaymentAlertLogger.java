...
public class PaymentAlertLogger {
	...
	public static Logger smpLogger() {
		...
		try {
			...
			fh = new FileHandler("E:\\Rishav\\Jars\\Payment_Alert_Automation\\Payment_Alert_Automation_Logs\\"+LocalDate.now().toString()+"_log.log",true);
