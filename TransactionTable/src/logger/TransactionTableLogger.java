...
public class TransactionTableLogger {
	...
	public static Logger smpLogger() {
		...
		try {
			...
			fh = new FileHandler("E:\\Rishav\\Jars\\Transaction_table_automation\\Transaction_table_logs\\"+LocalDate.now().toString()+"_log.log",true);
