...
public class Payfort_Missing_Payments_Logger {
	...
	public static Logger smpLogger() {
		...
		try {
			...
			fh = new FileHandler(
					"E:\\Shahid\\Jars\\Payfort_missing_payments_automation\\Payfort_missing_payments_automation_logs\\"
							+ LocalDate.now().toString() + "_log.log",true);
